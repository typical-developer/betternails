...
export default function ImageBentoGrid() {
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto">
      <div className="grid grid-cols-4 md:grid-cols-3 sm:grid-cols-2 auto-rows-[150px] gap-4 p-4">
        ...
        <img src={img3} className="col-span-1 row-span-2 w-full h-full object-cover rounded-2xl hover: scale-105 duration-150 ease-out" />
