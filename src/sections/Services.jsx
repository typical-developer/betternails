...
export default function Services() {
    ...
    return(
        <>
        <Section className="bg-white" sectionId="services" title={true} sectionTitle="Our Services">

                <div className="max-w-[1400px] grid md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
